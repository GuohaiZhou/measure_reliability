...
n100_summary = fread("X:/reliability_paper/Adams_Snijders_reliability/under_HGLM/gen_data_from_HGLM_n10_summary.csv")
...
fwrite(n10_summary,"n10_test_retest_added_HGLM.csv")
fwrite(n100_summary,"n100_test_retest_added_HGLM.csv")
fwrite(n1000_summary,"n1000_test_retest_added_HGLM.csv")